...
const Donnee = () =>{
    ...
    return(
        <>
            ...
            <Typography variant="subtitle1" gutterBottom className={classes.pgSize}>
            Le traitement des données collectées Les données personnelles des adhérents sont nécessaires à l’exercice des droits et obligations de l’adhérent.
            </Typography>
            <Typography variant="subtitle1" gutterBottom className={classes.pgSize}>
            ...
            <Typography variant="subtitle1" gutterBottom className={classes.pgSize}>
            La durée de conservation des données Les données personnelles collectées sont conservées pendant toute la durée de l’adhésion et pendant une période de 5 ans suivant la fin de l’adhésion. Vos droits sur vos données personnelles Vous pouvez accéder aux données vous concernant, les rectifier, demander leur effacement ou exercer votre droit à la limitation du traitement de vos données en application du Règlement RGDP.
            </Typography>
            </section>
            </div>
